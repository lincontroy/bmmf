...
!(function (e, t) {
  ...
  function Ee(e, t, n, s, i) {
    ...
    return (a = o <= 0 ? Fe((r = e - 1)) + o : o > Fe(e) ? ((r = e + 1), o - Fe(e)) : ((r = e), o)), { year: r, dayOfYear: a };
  }
  function Ae(e, t, n) {
    var s,
      i,
    ...
    if (!e._d) {
      ...
      for (
        o = e,
          ...
          null != e._dayOfYear && ((r = St(e._a[pe], s[pe])), (e._dayOfYear > Fe(r) || 0 === e._dayOfYear) && (y(e)._overflowDayOfYear = !0), (n = Ve(r, 0, e._dayOfYear)), (e._a[ve] = n.getUTCMonth()), (e._a[ke] = n.getUTCDate())),
          t = 0;
        t < 3 && null == e._a[t];
        ++t
      )
    ...
    if (e._f !== f.ISO_8601)
      if (e._f !== f.RFC_2822) {
        ...
        (y(e).charsLeftOver = d - c),
          ...
          null !== (a = y(e).era) && (e._a[pe] = e._locale.erasConvertYear(a, e._a[pe])),
          Yt(e),
          ct(e);
      } else Dt(e);
    else kt(e);
  ...
  (kn.calendar = function (e, t, n) {
    ...
    (kn.weekdaysParse = function (e, t, n) {
      ...
      for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), s = 0; s < 7; s++) {
        if (
          ((i = _([2e3, 1]).day(s)),
          n && !this._fullWeekdaysParse[s] && ((this._fullWeekdaysParse[s] = new RegExp("^" + this.weekdays(i, "").replace(".", "\\.?") + "$", "i")), (this._shortWeekdaysParse[s] = new RegExp("^" + this.weekdaysShort(i, "").replace(".", "\\.?") + "$", "i")), (this._minWeekdaysParse[s] = new RegExp("^" + this.weekdaysMin(i, "").replace(".", "\\.?") + "$", "i"))),
