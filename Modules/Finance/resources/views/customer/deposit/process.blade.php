@php
	$txn_data = json_decode($paymentRequest->txn_data);
@endphp
                    ...
                    <div class="text-center">
                        ...
                        <div class="row mt-2">
                            <div class="text-center mt-2">
                                ...
                                <a href="{{ $txn_data->status_url ?? null }}" class="btn btn-outline-stake"
                                    target="_blank">{{ localize('Txn Status') }}</a>
                                <a href="{{ $txn_data->checkout_url ?? null }}" class="btn btn-outline-stake"
