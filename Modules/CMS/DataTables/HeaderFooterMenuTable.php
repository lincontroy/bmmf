...
class HeaderFooterMenuTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $button .= '<a href="javascript:void(0);" class="btn btn-info-soft btn-sm m-1 edit-menu-button" title="'.localize("Edit").'" data-action="' . route('admin.cms.menu.update', ['article' => $query->id]) . '" data-route="' . route('admin.cms.menu.edit', ['article' => $query->id]) . '"><i class="fa fa-edit"></i></a>';
    ...
    {
        return $model->headerFooterMenu()->newQuery();
    }

    public function html(): HtmlBuilder
    {
        return $this->builder()
            ->setTableId('header-footer-menu-table')
    ...
    {
        return 'HeaderFooterMenus_' . date('YmdHis');
    }
