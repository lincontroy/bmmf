...
class JoinUsTodayTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $button .= '<a href="javascript:void(0);" class="btn btn-info-soft btn-sm m-1 edit-join-us-today-button" title="' . localize("Edit") . '" data-action="' . route('admin.cms.join-us-today.update', ['article' => $query->id]) . '" data-route="' . route('admin.cms.join-us-today.edit', ['article' => $query->id]) . '"><i class="fa fa-edit"></i></a>';
    ...
    {
        return $model->joinUsToday()->newQuery();
    }

    public function html(): HtmlBuilder
    {
        return $this->builder()
            ->setTableId('join-us-today-table')
    ...
    {
        return 'JoinUsToday_' . date('YmdHis');
    }
