...
class ContactAddressTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $button .= '<a href="javascript:void(0);" class="btn btn-info-soft btn-sm m-1 edit-contact-address-button" title="' . localize("Edit") . '" data-action="' . route('admin.cms.contact.address.update', ['article' => $query->id]) . '" data-route="' . route('admin.cms.contact.address.edit', ['article' => $query->id]) . '"><i class="fa fa-edit"></i></a>';

                $button .= '<a href="javascript:void(0);" class="btn btn-danger-soft btn-sm m-1 delete-button" title="' . localize("Delete") . '" data-action="' . route('admin.cms.contact.address.destroy', ['article' => $query->id]) . '"><i class="fa fa-trash"></i></a>';
    ...
    {
        return $model->contactAddress()->newQuery();
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('article_name')->title(localize('Address')),
    ...
    {
        return 'ContactAddress_' . date('YmdHis');
    }
