...
class CMSTopInvestorBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "top_investor_banner"       => ["required", "string"],
            'banner_image'              => ['nullable', 'file', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'banner_language_id'        => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "top_investor_banner_title" => ["required", "string"],
