...
class CMSOurDifferenceHeaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "our_difference_header"         => ["required", "string"],
            'header_language_id'               => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "our_difference_header_title"   => ["required", "string"],
            "our_difference_header_content" => ["required", "string"],
