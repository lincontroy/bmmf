...
class CMSSatisfiedCustomerHeaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "satisfied_customer_header"         => ["required", "string"],
            'header_language_id'                => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "satisfied_customer_header_title"   => ["required", "string"],
            "satisfied_customer_header_content" => ["required", "string"],
