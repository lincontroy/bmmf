...
class CMSTopInvestorHeaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "top_investor_header"         => ["required", "string"],
            'header_language_id'          => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "top_investor_header_title"   => ["required", "string"],
            "top_investor_header_content" => ["required", "string"],
