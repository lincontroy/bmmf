...
class CMSWhyChoseHeaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "why_choose_header"         => ["required", "string"],
            'header_language_id'        => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "why_choose_header_title"   => ["required", "string"],
            "why_choose_header_content" => ["required", "string"],
