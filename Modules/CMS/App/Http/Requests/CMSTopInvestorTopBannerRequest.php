...
class CMSTopInvestorTopBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "top_investor_top_banner"       => ["required", "string"],
            'top_banner_image'              => ['nullable', 'file', 'mimes:jpeg,jpg,png,gif', 'max:5120'],
            'top_banner_language_id'        => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "top_investor_top_banner_title" => ["required", "string"],
