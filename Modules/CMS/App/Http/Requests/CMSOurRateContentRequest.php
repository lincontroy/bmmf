...
class CMSOurRateContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $uniqueRule = Rule::unique(Article::class, 'article_name')
            ->where('slug', ArticleTypeEnum::OUR_RATE_CONTENT->value);
        ...
        return [
            "our_rate_content"       => ["required", "string", $uniqueRule],
            'language_id'            => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "our_rate_content_title" => ["required", "string"],
            "our_rate_content_body"  => ["required", "string"],
