...
class CMSOurRateHeaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            "our_rates_header"         => ["required", "string"],
            'header_language_id'       => ['required', 'integer', Rule::exists(Language::class, 'id')],
            "our_rates_header_title"   => ["required", "string"],
            "our_rates_header_content" => ["required", "string"],
