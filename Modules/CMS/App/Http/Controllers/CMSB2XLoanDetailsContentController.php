...
use Modules\CMS\App\Http\Requests\CMSB2XLoanDetailsContentRequest;
use Modules\CMS\App\Services\CMSB2XLoanDetailsContentService;

class CMSB2XLoanDetailsContentController extends Controller
{
    use ResponseTrait;
    ...
    /**
     * CMSB2XLoanDetailsContentController constructor
     *
     */
    public function __construct(
        private CMSB2XLoanDetailsContentService $cmsB2XLoanDetailsContentService,
    ...
    public function edit(int $articleId): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => localize("B2X Loan Details Content Data"),
     ...
     *
     * @param  CMSB2XLoanDetailsContentRequest  $request
     * @param  int  $languageId
     * @return RedirectResponse
     * @throws Exception
     */
    public function update(CMSB2XLoanDetailsContentRequest $request, int $articleId): JsonResponse
    {
        $data               = $request->validated();
        $data['article_id'] = $articleId;

        $article = $this->cmsB2XLoanDetailsContentService->update($data);

        return response()->json([
            'success' => true,
            'message' => localize("B2X Loan Details Content update successfully"),
            'title'   => localize("B2X Loan Details Content"),
            'data'    => $article,
        ]);
    }
    ...
    /**
     * Get Article Loan Details Content the specified resource.
     *
     * @param  int  $languageId
     * @param  int  $articleId
     * @return JsonResponse
