...
class CMSB2XLoanController extends Controller
{
    ...
    /**
     * CMSB2XLoanController constructor
     *
     */
    ...
    public function edit(int $articleId): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => localize("B2X Loan Data"),
     ...
     *
     * @param  CMSB2XLoanRequest  $request
     * @param  int  $languageId
     * @return RedirectResponse
     * @throws Exception
     */
    public function update(CMSB2XLoanRequest $request, int $articleId): JsonResponse
    {
        $data               = $request->validated();
        $data['article_id'] = $articleId;

        $article = $this->cmsB2XLoanService->update($data);

        return response()->json([
            'success' => true,
            'message' => localize("B2X Loan update successfully"),
            'title'   => localize("B2X Loan"),
            'data'    => $article,
        ]);
    }
    ...
    /**
     * Get Article loan the specified resource.
     *
     * @param  int  $languageId
     * @param  int  $articleId
     * @return JsonResponse
