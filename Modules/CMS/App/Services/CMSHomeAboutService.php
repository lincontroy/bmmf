...
class CMSHomeAboutService
{
    /**
     * CMSHomeAboutService constructor.
     *
     */
    ...
    public function create(array $attributes): bool
    {
        try {
            ...
            if ($article) {
                ...
                $articleDataInsertData = [
                    [
                        ...
                        'content'    => ImageHelper::upload($attributes['image'] ?? null, 'home-about'),
                    ],
                    [
                        'article_id' => $article->id,
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Home About create error"),
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            if ($articleUpdateCheck) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['image'])) {
                                $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'home-about', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        elseif (isset($attributes['image'])) {
                            $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'home-about');
                            $this->articleDataRepository->create($data);
                        }
                    }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'language_id'   => $attributes['language_id'],
                        'slug'          => ArticleLangDataTypeEnum::ABOUT_TITLE->value,
                        'large_content' => $attributes['about_title'],
                    ],
                    [
                        'article_id'    => $articleId,
                        'language_id'   => $attributes['language_id'],
                    ...
                    [
                        ...
                        'language_id'   => $attributes['language_id'],
                        'slug'          => ArticleLangDataTypeEnum::ABOUT_CONTENT->value,
                        'large_content' => $attributes['about_content'],
                    ],
                    [
                        'article_id'    => $articleId,
                        'language_id'   => $attributes['language_id'],
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Home About update error"),
                'title'   => localize('Home About'),
                'errors'  => $exception,
            ], 422));
        }
     ...
     * @throws Exception
     */
    public function updateBanner(array $attributes): bool
    {
        $articleId = $attributes['article_id'];
        ...
        try {
            ...
            $articleUpdateData = [
                'slug'         => ArticleTypeEnum::ABOUT_US_BANNER->value,
                'article_name' => $attributes['about_us_banner'],
            ...
            if ($articleUpdateCheck) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['banner_image'])) {
                                $data['content'] = ImageHelper::upload($attributes['banner_image'] ?? null, 'home-about', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        elseif (isset($attributes['banner_image'])) {
                            $data['content'] = ImageHelper::upload($attributes['banner_image'] ?? null, 'home-about');
                            $this->articleDataRepository->create($data);
                        }
                    }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::ABOUT_US_BANNER_TITLE->value,
                        'small_content' => $attributes['about_us_banner_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("About Us Banner update error"),
