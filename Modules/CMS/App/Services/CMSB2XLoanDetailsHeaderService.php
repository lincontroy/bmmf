...
class CMSB2XLoanDetailsHeaderService
{
    /**
     * CMSB2XLoanDetailsHeaderService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['b2x_loan_details_header'],
                'status'       => $attributes['loan_details_header_status'],
            ];
            ...
            if ($articleUpdateCheck) {
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'language_id'   => $attributes['loan_details_header_language_id'],
                        'slug'          => ArticleLangDataTypeEnum::B2X_LOAN_DETAILS_HEADER_TITLE->value,
                        'small_content' => $attributes['new_b2x_loan_details_header_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("B2X Loan Details Header update error"),
