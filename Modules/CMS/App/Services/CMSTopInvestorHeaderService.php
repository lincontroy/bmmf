...
class CMSTopInvestorHeaderService
{
    /**
     * CMSTopInvestorHeaderService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['top_investor_header'],
            ...
            if ($articleUpdateCheck) {
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::TOP_INVESTOR_HEADER_TITLE->value,
                        'small_content' => $attributes['top_investor_header_title'],
                    ],
                    [
                        'article_id'    => $articleId,
                        'language_id'   => $attributes['header_language_id'],
                        'slug'          => ArticleLangDataTypeEnum::TOP_INVESTOR_HEADER_CONTENT->value,
                        'small_content' => $attributes['top_investor_header_content'],
                    ],
                ];
