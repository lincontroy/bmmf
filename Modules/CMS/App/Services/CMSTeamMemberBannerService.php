...
class CMSTeamMemberBannerService
{
    /**
     * CMSTeamMemberBannerService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['team_member_banner'],
            ...
            if ($articleUpdateCheck) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['banner_image'])) {
                                $data['content'] = ImageHelper::upload($attributes['banner_image'] ?? null, 'team-member', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        if (isset($data['content'])) {
                            ...
                            $data['content'] = ImageHelper::upload($attributes['banner_image'] ?? null, 'team-member');
                            $this->articleDataRepository->create($data);
                        }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::TEAM_MEMBER_BANNER_TITLE->value,
                        'small_content' => $attributes['team_member_banner_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Team Member Banner update error"),
