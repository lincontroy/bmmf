...
class CMSTopInvestorTopBannerService
{
    /**
     * CMSTopInvestorTopBannerService constructor.
     *
     */
    ...
    /**
     * Update CMS top investor top banner
     *
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['top_investor_top_banner'],
            ...
            if ($articleUpdateCheck) {
                ...
                foreach ($articleDataInsertData as $data) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['top_banner_image'])) {
                                $data['content'] = ImageHelper::upload($attributes['top_banner_image'] ?? null, 'top-investor', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        } elseif (isset($attributes['top_banner_image'])) {
                            $data['content'] = ImageHelper::upload($attributes['top_banner_image'] ?? null, 'top-investor');
                            $this->articleDataRepository->create($data);
                        }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::TOP_INVESTOR_TOP_BANNER_TITLE->value,
                        'small_content' => $attributes['top_investor_top_banner_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Top Investor Top Banner update error"),
