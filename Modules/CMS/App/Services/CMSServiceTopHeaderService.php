...
class CMSServiceTopHeaderService
{
    /**
     * CMSServiceTopHeaderService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['service_top_banner'],
            ...
            if ($articleUpdateCheck) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['top_banner_image'])) {
                                $data['content'] = ImageHelper::upload($attributes['top_banner_image'] ?? null, 'service-top-banner', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        if (isset($data['content'])) {
                            ...
                            $data['content'] = ImageHelper::upload($attributes['top_banner_image'] ?? null, 'service-top-banner');
                            $this->articleDataRepository->create($data);
                        }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::SERVICE_TOP_BANNER_TITLE->value,
                        'small_content' => $attributes['service_top_banner_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Service Top Banner update error"),
