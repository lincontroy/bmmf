...
class CMSMerchantContentService
{
    /**
     * CMSMerchantContentService constructor.
     *
     */
    ...
    public function create(array $attributes): bool
    {
        try {
            DB::beginTransaction();
            $articleInsertData = [
                'slug'         => ArticleTypeEnum::MERCHANT_CONTENT->value,
                'article_name' => $attributes['merchant_content'],
            ...
            if ($article) {
                ...
                $articleDataInsertData = [
                    [
                        ...
                        'content'    => ImageHelper::upload($attributes['image'] ?? null, 'merchant-content'),
                    ],
                ];
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::MERCHANT_CONTENT_HEADER->value,
                        'large_content' => $attributes['merchant_content_header'],
                    ],
                    [
                        'article_id'    => $article->id,
                        'language_id'   => $attributes['language_id'],
                        'slug'          => ArticleLangDataTypeEnum::MERCHANT_CONTENT_BODY->value,
                        'large_content' => $attributes['merchant_content_body'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Merchant Content create error"),
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['image'])) {
                                $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'merchant-content', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        if (isset($data['content'])) {
                            ...
                            $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'merchant-content');
                            $this->articleDataRepository->create($data);
                        }
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Merchant Content update error"),
                'title'   => localize('Merchant Content'),
                'errors'  => $exception,
            ], 422));
        }
    ...
    public function destroy(array $attributes): bool
    {
        ...
        try {
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Merchant Content delete error"),
                'title'   => localize('Merchant Content'),
