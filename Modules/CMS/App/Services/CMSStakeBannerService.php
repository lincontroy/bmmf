...
class CMSStakeBannerService
{
    /**
     * CMSStakeBannerService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['stake_banner'],
            ...
            if ($articleUpdateCheck) {
                    ...
                    if ($articleData) {
                        ...
                        if ($data['slug'] != ArticleDataTypeEnum::IMAGE->value) {
                            ...
                            if (isset($attributes['image'])) {
                                $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'stake-banner', $articleData['content']);
                                $this->articleDataRepository->updateByCondition(['article_id' => $articleId, 'slug' => $data['slug']], $data);
                            }
                        ...
                        if (isset($data['content'])) {
                            ...
                            $data['content'] = ImageHelper::upload($attributes['image'] ?? null, 'stake-banner');
                            $this->articleDataRepository->create($data);
                        }
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::STAKE_BANNER_TITLE->value,
                        'small_content' => $attributes['stake_banner_title'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Stake Banner update error"),
