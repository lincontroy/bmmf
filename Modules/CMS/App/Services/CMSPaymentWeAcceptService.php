...
class CMSPaymentWeAcceptService
{
    /**
     * CMSPaymentWeAcceptService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['payment_we_accept_header'],
            ...
            if ($articleUpdateCheck) {
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::PAYMENT_WE_ACCEPT_HEADER_TITLE->value,
                        'small_content' => $attributes['payment_we_accept_header_title'],
                    ],
                    [
                        'article_id'    => $articleId,
                        'language_id'   => $attributes['header_language_id'],
                        'slug'          => ArticleLangDataTypeEnum::PAYMENT_WE_ACCEPT_HEADER_CONTENT->value,
                        'large_content' => $attributes['payment_we_accept_header_content'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Payment We Accept update error"),
