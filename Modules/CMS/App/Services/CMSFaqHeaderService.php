...
class CMSFaqHeaderService
{
    /**
     * CMSFaqHeaderService constructor.
     *
     */
    ...
    public function update(array $attributes): bool
    {
        ...
        try {
            ...
            $articleUpdateData = [
                'article_name' => $attributes['faq_header'],
            ...
            if ($articleUpdateCheck) {
                ...
                $articleLangDataInsertData = [
                    [
                        ...
                        'slug'          => ArticleLangDataTypeEnum::FAQ_HEADER_TITLE->value,
                        'small_content' => $attributes['faq_header_title'],
                    ],
                    [
                        'article_id'    => $articleId,
                        'language_id'   => $attributes['header_language_id'],
                        'slug'          => ArticleLangDataTypeEnum::FAQ_HEADER_CONTENT->value,
                        'large_content' => $attributes['faq_header_content'],
                    ],
                ];
            ...
            throw new HttpResponseException(response()->json([
                'success' => false,
                'message' => localize("Faq Header update error"),
