...
@endphp
<div class="modal fade" id="updateWhyChoseHeader" tabindex="-1" aria-labelledby="updateWhyChoseHeaderLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content radius-35">
            <div class="modal-header p-4">
                <h5 class="modal-title text-color-5 fs-20 fw-medium" id="modelWhyChoseLabel">
                    {{ localize('Update Why Chose Header') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 pt-2">
                <form action="#" method="post" class="needs-validation" data="showHeaderCallBackData"
                    id="why-chose-header-form" novalidate="" data-insert="#" enctype="multipart/form-data"
                    data-getData="{{ route('admin.cms.why-chose.header.getArticleLang', [':language', ':article']) }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="why_choose_header">{{ localize('Header') }} <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="why_choose_header" id="why_choose_header"
                                    value="{{ old('name') }}"
                                    class="custom-form-control form-control @error('why_choose_header') is-invalid @enderror"
                                    placeholder="{{ localize('enter header') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('why_choose_header')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="why_choose_header_title">{{ localize('Header title') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="why_choose_header_title" id="why_choose_header_title"
                                    value="{{ old('name') }}"
                                    class="custom-form-control form-control @error('why_choose_header_title') is-invalid @enderror"
                                    placeholder="{{ localize('enter header title') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('why_choose_header_title')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="why_choose_header_content">{{ localize('Header Content') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="why_choose_header_content" id="why_choose_header_content"
                                    value="{{ old('name') }}"
                                    class="custom-form-control form-control @error('why_choose_header_content') is-invalid @enderror"
                                    placeholder="{{ localize('enter header content') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('why_choose_header_content')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                    ...
                    <div class="d-flex flex-row gap-3">
                        ...
                        <button type="submit" class="actionBtn btn btn-save py-2 w-75"
                            id="whyChoseHeaderFormActionBtn">{{ localize('Create') }}</button>
                    </div>
                </form>
            </div>
        </div>
