        ...
        <div class="modal-content radius-35">
            <div class="modal-header p-4">
                <h5 class="modal-title text-color-5 fs-20 fw-medium" id="modelHeaderLabel">
                    {{ localize('Update Team Member Header') }}</h5>
                ...
                <form action="#" method="post" class="needs-validation" data="showHeaderCallBackData"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="team_header">{{ localize('Team Member Header') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="team_header" id="team_header"
                                    value="{{ old('team_header') }}"
                                    class="custom-form-control form-control @error('team_header') is-invalid @enderror"
                                    placeholder="{{ localize('enter team header') }}" required />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="team_header_title">{{ localize('Team Header Title') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="team_header_title" id="team_header_title"
                                    value="{{ old('team_header_title') }}"
                                    class="custom-form-control form-control @error('team_header_title') is-invalid @enderror"
                                    placeholder="{{ localize('enter team header title') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('team_header_title')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="team_header_content">{{ localize('Team Header Content') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="team_header_content" id="team_header_content"
                                    value="{{ old('team_header_content') }}"
                                    class="custom-form-control form-control @error('team_header_content') is-invalid @enderror"
                                    placeholder="{{ localize('enter team header Content') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('team_header_content')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
