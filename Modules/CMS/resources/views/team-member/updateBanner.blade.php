        ...
        <div class="modal-content radius-35">
            <div class="modal-header p-4">
                <h5 class="modal-title text-color-5 fs-20 fw-medium" id="modelBannerLabel">
                    {{ localize('Update Team Member Banner') }}</h5>
            ...
            <div class="modal-body p-4 pt-2">
                <form action="#" method="post" class="needs-validation" data="showBannerCallBackData"
                    ...
                    data-getData="{{ route('admin.cms.team-member.banner.getArticleDataLang', [':language', ':article']) }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="team_member_banner">{{ localize('Team Member Banner') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="team_member_banner" id="team_member_banner"
                                    value="{{ old('team_member_banner') }}"
                                    class="custom-form-control form-control @error('team_member_banner') is-invalid @enderror"
                                    placeholder="{{ localize('enter team member banner') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('team_member_banner')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label text-start text-color-1 fs-16 fw-medium"
                                    for="team_member_banner_title">{{ localize('Team Member Banner Title') }} <span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" name="team_member_banner_title" id="team_member_banner_title"
                                    value="{{ old('team_member_banner_title') }}"
                                    class="custom-form-control form-control @error('team_member_banner_title') is-invalid @enderror"
                                    placeholder="{{ localize('enter team member banner title') }}" required />
                                <div class="invalid-feedback" role="alert">
                                    @error('team_member_banner_title')
                                        {{ $message }}
                                    @enderror
                                </div>
                            </div>
