...
<x-app-layout>
            ...
            <div class="col-12">
                <div class="card py-4 px-3 radius-15">
                    <div class="d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-center mb-3">
                        <ul class="nav nav-pills  customer-details mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-deposit-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="pills-deposit" aria-selected="true">{{ localize('deposit') }}
                                    (<span class="totalCount">{{ count($deposits) }}</span>)
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-withdraw-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-withdraw" type="button" role="tab"
                                    aria-controls="pills-withdraw" aria-selected="false">{{ localize('withdraw') }}
                                    (<span class="totalCount">{{ count($withdraws) }}</span>)
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-investment-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-investment" type="button" role="tab"
                                    aria-controls="pills-investment" aria-selected="false">{{ localize('investment') }}
                                    (<span class="totalCount">{{ count($investments) }}</span>)
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-transfer-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-transfer" type="button" role="tab"
                                    aria-controls="pills-transfer" aria-selected="false">{{ localize('transfer') }}
                                    (<span class="totalCount">{{ count($transfers) }}</span>)
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-received-amount-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-received" type="button" role="tab"
                                    aria-controls="pills-received" aria-selected="false">{{ localize('received') }}
                                    (<span class="totalCount">{{ count($received) }}</span>)
                                </button>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
                            ...
                            <div
                                class="d-flex flex-column flex-sm-row mb-4 mt-0 text-center text-sm-start user-profile-header">
                                        ...
                                        <div class="user-profile-info">
                                            ...
                                            <ul
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <span class="fs-16 fw-normal">{{ localize('ID') }} :
                                                        {{ $customer['user_id'] }}</span>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <ul class="list-unstyled mb-4">
                                                ...
                                                <li class="d-flex align-items-center mb-3">
                                                    ...
                                                    @elseif($customer->verified_status->value === CustomerVerifyStatusEnum::NOT_SUBMIT->value)
                                                        <span class="badge bg-label-primary py-2"
                                                    ...
                                                    @elseif($customer->verified_status->value === CustomerVerifyStatusEnum::CANCELED->value)
                                                        <span class="badge bg-label-danger py-2"
                                                              role="status">{{ str_replace('_', ' ', CustomerVerifyStatusEnum::CANCELED->name) }}</span>
                                                    @else
                                                        <a href="#" class="badge bg-label-success py-2">
                            ...
                            <table id="deposit-table" class="table">
                                ...
                                <tbody>
                                    @foreach ($deposits as $key => $deposit)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ get_ymd($deposit['date']) }}</td>
                                            <td>{{ $deposit['method'] }}</td>
                                            <td>{{ $deposit['amount'] }}</td>
                                            <td>{{ $deposit['currencyInfo']['name'] }}</td>
                                            <td>{{ $deposit['fees'] }}</td>
                                            <td>{{ $deposit['comments'] }}</td>
                                            <td class="text-center">
                                                <?php
                                                if ($deposit['status']->value === DepositEnum::CONFIRM->value) {
                                                    $button = '<span class="badge bg-label-success py-2 w-px-75">' . DepositEnum::CONFIRM->name . '</span>';
                                                } elseif ($deposit['status']->value === DepositEnum::CANCEL->value) {
                        ...
                        <div class="tab-pane fade" id="pills-withdraw" role="tabpanel"
                            ...
                            <table id="c-withdraw-table" class="table">
                                <thead>
                                    <tr>
                                        <th>{{ localize('sl') }}</th>
                                        <th>{{ localize('date') }}</th>
                                ...
                                <tbody>
                                    @foreach ($withdraws as $key => $deposit)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ get_ymd($deposit['request_date']) }}</td>
                                            <td>{{ $deposit['method'] }}</td>
                                            <td>{{ $deposit['amount'] }}</td>
                                            <td>{{ $deposit['currencyInfo']['name'] }}</td>
                                            <td>{{ $deposit['fees'] }}</td>
                                            ...
                                            <td>
                                                <?php
                                                if ($deposit['status']->value === WithdrawStatusEnum::SUCCESS->value) {
                                                    $button = '<span class="badge bg-label-success py-2 w-px-75">' . WithdrawStatusEnum::SUCCESS->name . '</span>';
                                                } elseif ($deposit['status']->value === WithdrawStatusEnum::CANCEL->value) {
                                                    $button = '<span class="badge bg-label-danger py-2 w-px-75">' . WithdrawStatusEnum::CANCEL->name . '</span>';
                                                } else {
                                                    $button = '<span class="badge bg-label-warning py-2"><i class="fa fa-spinner fa-spin"   ></i> ' . WithdrawStatusEnum::PENDING->name . '</span>';
                                                }
                                                echo $button;
                                                ?>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="pills-investment" role="tabpanel"
                            aria-labelledby="pills-investment-tab">
                            <table id="investment-table" class="table">
                                <thead>
                                    <tr>
                                        <th>{{ localize('sl') }}</th>
                                        <th>{{ localize('date') }}</th>
                                        <th>{{ localize('order_ID') }}</th>
                                ...
                                <tbody>
                                    @foreach ($investments as $key => $invest)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ get_ymd($invest['created_at']) }}</td>
                                            <td>{{ $invest['id'] }}</td>
                                            <td>{{ $invest['package']['name'] }}</td>
                                            <td>{{ $invest['total_invest_amount'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <table id="transfer-table" class="table">
                                ...
                                <tbody>
                                    @foreach ($transfers as $key => $transfer)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ get_ymd($transfer['date']) }}</td>
                                            <td>{{ $transfer['receiverInformation']['first_name'] . ' ' . $transfer['receiverInformation']['last_name'] }}
                                            </td>
                        ...
                        <div class="tab-pane fade" id="pills-received" role="tabpanel"
                            ...
                            <table id="receiver-table" class="table">
                                <thead>
                                    <tr>
                                        <th>{{ localize('sl') }}</th>
                                        <th>{{ localize('date') }}</th>
                                        <th>{{ localize('sender') }}</th>
                                        <th>{{ localize('amount') }}</th>
                                        <th>{{ localize('fees') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($received as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ get_ymd($item['date']) }}</td>
                                            <td>{{ $item['senderInformation']['first_name'] . ' ' . $item['senderInformation']['last_name'] }}
                                            </td>
                                            <td>{{ $item['amount'] }}</td>
                                            <td>{{ $item['fees'] }}</td>
                                        </tr>
    ...
    @push('css')
        ...
        <link rel="stylesheet" href="{{ assets('customer/css/app.css?v=4') }}">
    @endpush
    ...
    @push('js')
        <script src="{{ assets('customer/js/customer_details.js') }}"></script>
